...
import {
  ...
  ExternalLink, Grid, List, MoreVertical, Share2,
  Star, StarOff, Archive, RefreshCw, ZoomIn, Maximize2,
  Cloud, Database, Clock, File, Image, Video, Music
} from 'lucide-react';
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="p-4 md:p-6 pt-20">
          <div className="border-b border-gray-200 pb-6">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Manage student attendance and mark List</h1>
            <p className="text-gray-600 mt-2">Cloudinary Storage Dashboard</p>
          </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-4 md:p-6 mb-4 md:mb-6">
                ...
                <div className="mt-6 md:mt-8 pt-4 md:pt-6 border-t border-gray-200">
                  <div className="text-sm text-gray-600 mb-2">
                    ...
                    <p className="text-xs mt-1">Cloud: {cloudName}</p>
                    <p className="text-xs">Storage: Local Browser Storage</p>
                  </div>
                </div>
              </div>
            </div>
